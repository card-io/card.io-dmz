...
// digit categorizers
#include "models/expiry/bisectors/a/modelm_b8c71409.hpp"
#include "models/expiry/bisectors/b/modelm_15a2927a.hpp"
#include "models/expiry/bisectors/c/modelm_16d95fdf.hpp"
#include "models/expiry/bisectors/d/modelm_47b13bb4.hpp"
...
#define NUMBER_OF_BISECTORS 4
  ...
  bisector_results[0] = applym_b8c71409(input);
  bisector_results[1] = applym_15a2927a(input);
  bisector_results[2] = applym_16d95fdf(input);
  bisector_results[3] = applym_47b13bb4(input);
  
#if DEBUG_EXPIRY_CATEGORIZATION_RESULTS
  dmz_debug_print("%1.0f %1.0f %1.0f %1.0f\n", bisector_results[0][0], bisector_results[1][0], bisector_results[2][0], bisector_results[3][0]);
#endif
